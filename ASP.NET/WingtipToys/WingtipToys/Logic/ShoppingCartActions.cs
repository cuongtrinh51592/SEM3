    ...
    public class ShoppingCartActions : IDisposable
    {
        ...
        public void AddToCart(int id)
        {
            ...
            if (cartItem == null)
            {
                ...
                {
                    ItemId = Guid.NewGuid().ToString(), ProductId = id, CartId = ShoppingCartId,
                    Product = _db.Products.SingleOrDefault(p => p.ProductID == id), Quantity = 1,
        ...
        public void EmptyCart()
        {
            ...
            {
                _db.ShoppingCartItems.Remove(carItem);
            }
            //Save changes
            _db.SaveChanges();  
        }
